...
const Income = () => {
  ...
  return (
    ...
    <button onClick={handle2} className='btn12'>Call</button>
    <button onClick={d3} className='btn22'>delete</button>
    </div>
    </fieldset>
    <fieldset className='ff22'>
    <img className='i12' src='https://png.pngtree.com/png-clipart/20190520/original/pngtree-business-male-icon-vector-png-image_4187852.jpg'/>
    <hr/>
    <center>
    <h2>Altrin</h2>
    <h4>7094741364</h4>
    ...
    <div className='login-btn2'>
    <button onClick={handle1} className='btn12'>Call</button>
    <button onClick={d2} className='btn22'>delete</button>
    </div>
    </fieldset>
    </div>
    <br></br>
    <br/>
   <center><h1 className='t12'>Yesterday</h1></center>
    <br></br>
    <br/>
    <div className='f12'>
    <fieldset className='ff12'>
    ...
    <div className='login-btn2'>
    <button onClick={handle} className='btn12'>Call</button>
    <button onClick={d1} className='btn22'>delete</button>
    </div>
    </fieldset>
    </div>
    </div>
