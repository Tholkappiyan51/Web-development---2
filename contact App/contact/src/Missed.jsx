...
const Missed = () => {
  ...
  return (
    ...
    <div className='missbody'>
    <center><h1 className='t13'>Today</h1></center>
    <div className='f13'>
    <fieldset className='ff13'>
    <img className='i13' src='https://png.pngtree.com/png-clipart/20190520/original/pngtree-business-male-icon-vector-png-image_4187852.jpg'/>
    <hr/>
    <center>
    <h2>Aravind</h2>
    <h4>7094741364</h4>
    ...
    <div className='login-btn3'>
    <button onClick={handle2} className='btn13'>Call</button>
    <button onClick={d3} className='btn23'>delete</button>
    </div>
    </fieldset>
    <fieldset className='ff23'>
    <img className='i13' src='https://png.pngtree.com/png-clipart/20190520/original/pngtree-business-male-icon-vector-png-image_4187852.jpg'/>
    ...
    <div className='login-btn3'>
    <button onClick={handle1} className='btn13'>Call</button>
    <button onClick={d2} className='btn23'>delete</button>
    </div>
    </fieldset>
    </div>
    </div>
